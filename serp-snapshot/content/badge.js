...
(function (root) {
  ...
  var STYLE = [
    ...
    '.dot { width: 8px; height: 8px; border-radius: 50%; background: #1a73e8; flex: 0 0 auto; }',
    '.dot.busy { background: #f9ab00; animation: pulse 1s ease-in-out infinite; }',
    '.dot.ok { background: #1e8e3e; }',
    '.dot.err { background: #d93025; }',
